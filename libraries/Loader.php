...
class CI_Loader {
	...
	function dbutil()
	{
		...
		require_once(BASEPATH.'DB_utility'.EXT);
		require_once(BASEPATH.'drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_utility'.EXT);
	...
	function dbforge()
	{
		...
		require_once(BASEPATH.'DB_forge'.EXT);
		require_once(BASEPATH.'drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_forge'.EXT);
